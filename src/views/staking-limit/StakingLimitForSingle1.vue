...
import {
  DAOAddress,
  DSTAddress,
  StakingLimitForSingleTokenAddress1,
  StakingLimitForSingleContractAddress1
} from "@/constants";
  ...
  methods: {
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingLimitForSingleContractAddress1)
        .call();
    ...
    handleApprove() {
      this.loading = true;
      // 执行合约
      getContract(ERC20DAO, StakingLimitForSingleTokenAddress1, this.web3)
        .methods.approve(
          StakingLimitForSingleContractAddress1,
