...
import {
  DAOAddress,
  DSTAddress,
  StakingInviterForLPTokenAddress3,
  StakingInviterForLPContractAddress3
} from "@/constants";
  ...
  methods: {
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingInviterForLPContractAddress3)
        .call();
    ...
    // 跳转历史记录
    gotoHistory() {
      this.$router.push({ path: "/staking/lp/6/history" });
    }
  }
};
</script>
