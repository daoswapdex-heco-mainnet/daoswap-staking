...
import {
  DAOAddress,
  DSTAddress,
  StakingInviterForSingleTokenAddress1,
  StakingInviterForSingleContractAddress1
} from "@/constants";
  ...
  methods: {
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingInviterForSingleContractAddress1)
        .call();
    ...
    // 跳转历史记录
    gotoHistory() {
      this.$router.push({ path: "/staking-inviter/single/1/history" });
    }
  }
};
</script>
