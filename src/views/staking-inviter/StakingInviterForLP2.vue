...
import {
  DAOAddress,
  DSTAddress,
  StakingInviterForLPTokenAddress2,
  StakingInviterForLPContractAddress2
} from "@/constants";
  ...
  methods: {
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingInviterForLPContractAddress2)
        .call();
    ...
    // 跳转历史记录
    gotoHistory() {
      this.$router.push({ path: "/staking/lp/5/history" });
    }
  }
};
</script>
